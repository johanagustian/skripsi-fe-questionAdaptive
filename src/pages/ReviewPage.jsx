...
const ReviewPage = () => {
  ...
  if (reviewData.length === 0)
    return <div className="p-10 text-center">Review data not found.</div>;
    ...
    <div className="hp-wrapper">
      <main className="at-content-container">
        <div
          ...
          className="rv-question-card rv-reading-context-card"
        >
          <div className="qz-header-row">
            <h2 className="qz-context-title">Reading Context</h2>
          ...
          <div className="qz-context-body">
            <p className="qz-review-mode-warning">
              *Mode Review: You are currently viewing the review of completed
              practice questions.
            </p>
            ...
            >
              {currentQuiz.reading_context ? (
                ...
                <p style={{ margin: 0 }}>
                  No reading text available for this question.
                </p>
              )}
            </div>
          </div>
        ...
        <div
          className="at-bottom-layout-wrapper"
          style={{
            display: "flex",
            gap: "30px",
        ...
        >
          <div
            className="rv-question-card"
            style={{ flex: 1, margin: 0, width: "100%" }}
          >
            <h3
              className="rv-question-text"
              style={{
                fontWeight: "600",
                marginBottom: "20px",
                fontSize: "15px",
            ...
            <div
              ...
              style={{
                borderLeft: `4px solid ${currentQuiz.is_correct ? "#10b981" : "#ef4444"}`,
            ...
            >
              ...
              >
                Correct Answer: <strong>{currentQuiz.correct_answer}</strong>
              </p>
            </div>
          </div>

          <div
            className="rv-sidebar-right"
            style={{
              width: "320px",
              flexShrink: 0,
              position: "static",
            ...
            >
              {reviewData.map((item, i) => (
                <button
                  ...
                  style={{
                    borderBottom: `3px solid ${item.is_correct ? "#10b981" : "#ef4444"}`,
                  }}
                >
                  {i + 1}
                </button>
